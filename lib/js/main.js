import * as BotEvents from './modules/event_bot_btn.js'
import * as WindowEvents from './modules/event_bot_window.js'
...
export default class Chottobotto {
    ...
    constructor() {
        ...
        BotEvents.LoadBtnEvents();
        WindowEvents.LoadWindowEvents();
    }
    ...
    SetBotSize ( bot_height, bot_width ) {
        ...
        /*this.sm.matches ? btn_bot.style.width = "auto" : 
        this.md.matches ? btn_bot.style.width = "auto" :
        this.lg.matches ? btn_bot.style.width = "auto" :
        this.xl.matches ? btn_bot.style.width = "auto" : btn_bot.style.width = "auto";

        this.sm.matches ? btn_bot.style.height = "auto" : 
        this.md.matches ? btn_bot.style.height = "auto" :
        this.lg.matches ? btn_bot.style.height = "auto" :
        this.xl.matches ? btn_bot.style.height = "auto" : btn_bot.style.height = "auto";*/
    ...
    SetBotText ( text_content, text_color ) {
        ...
        text_content ? text.innerHTML = text_content : text.innerHTML = "Help";
