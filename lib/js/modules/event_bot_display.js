...
function OpenCloseWindow(win) {
    ...
    const all_options = document.querySelectorAll("#win_container button");
...
function CreateArea(options, len, index) {
    ...
    const all_text = document.querySelectorAll("#win_container p");
    all_text[index].style.display = "block";
}

function ResetBot(last_title) {

    let all_text = document.querySelectorAll("#win_container p");
    let all_buttons = document.querySelectorAll("#win_container button");
